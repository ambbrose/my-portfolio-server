...
const ServiceForm: React.FC<ServiceFormProps> = ({ initialData }) => {
    ...
    const description = initialData ? "Edit the current service" : "Add a new service";
    ...
    const onSubmit = async (data: ServiceFormValues) => {
        try {
            ...
            if (initialData) {
                await axios.patch(`/api/dashboard/services/${params.serviceId}`, data);
            } else {
                await axios.post(`/api/dashboard/services`, data);
            };
    ...
    const onDelete = async () => {
        try {
            ...
            await axios.delete(`/api/dashboard/service/${params.serviceId}`);
